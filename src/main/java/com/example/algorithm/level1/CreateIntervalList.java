...
/**
 * CreateIntervalList x만큼 간격이 있는 n개의 숫자
 * 
 ...
 */
public interface CreateIntervalList {
    /**
     * 
     * @param x x는 -10000000 이상, 10000000 이하인 정수입니다.
     * @param n n은 1000 이하인 자연수입니다.
     * @return x간격만큼 증가되는 n개의 숫자를 가진 long[]
     */
